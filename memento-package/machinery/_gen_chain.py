...
def check(repo=ROOT):
    ...
    if stamp is None:
        return cna.refuse(OUT_NAME, f"the committed file carries NO READABLE UNIT STAMP "
                          ...
                          f"`python3 knowledge/_gen_chain.py`.")
    if stamp != live_tier:

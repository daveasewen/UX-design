...
> **pre-flight #95 (RETROSPECTIVE, declared):** boot 65,657 real (`message.usage` first turn; n=6). No opener check-in — first fill read came AFTER the serials, which is the defect named in this banner.

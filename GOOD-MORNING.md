...
> 8K warn / 12K block — `_RUNBOOK-capture-ritual.md` step 2. **Compactable ~11.6K tk = WARN — the tightest it has been; this wrap hit the 12K BLOCK twice and paid down both times (2f stratum roll · item-0 receipt · prose trim).** ⚠ **#28 MUST PAY BEFORE IT SPENDS** — a normal banner (~1.0–1.2K) crosses the block on its own. Cheapest payers in order: §C·2 (C2+C2b = 1,560 tk, several items stale), DOFIRST (2.3K), STRATA (1.2K, 2f-rollable). Do NOT chase below 8K; §A is exempt. Chain cap 24K is ADVISORY (M10, #18); ⚠ the 28,000 promotion threshold is still CROSSED (chain 33,162 tk at this wrap); the payer remains LS's standing body (§C·4 M10 line), not the deltas.

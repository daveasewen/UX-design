...
- **dataviz/dv-legend** — `knowledge/canon/dv-legend.js` · 15131 bytes (14.8 KB of 16 KB) · 6 member(s)
- **dataviz/dv-donut-sweep** — `knowledge/canon/dv-donut-sweep.js` · 5511 bytes (5.4 KB of 16 KB) · 6 member(s)

- **dataviz — page budget:** 32690 bytes (31.9 KB of 32 KB, 100%) across 3 source(s)

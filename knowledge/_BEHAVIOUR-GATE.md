...
- **dataviz — page budget (worst member):** 24671 code-only bytes (24.1 KB of 34 KB, 71%) across 3 source(s)
    ...
    - `Template-dashboard-bento` — 13048 bytes · consumes dv-behaviour

...
**18/38 of our SCs have at least one axe-core rule tagged against them.** 20 have no OSS axe-core coverage at all — genuinely manual/bespoke territory for now.

## Easy wins — axe-core covers it, we haven't wired it up (16)
...
## No OSS axe-core coverage found (20)

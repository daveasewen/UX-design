...
**Totals:** 32 components · 19 with deprecated bindings · 13 god-nodes (blast≥7).
...
|---|---|---|---|---|---|---|
| Accordion | mol | 8 | background/default, icon/default, background/hover, text/default | 1.4.3, 2.1.1, 2.4.7, 2.5.8, 4.1.2 | elevation, contextual-help |  |
| Avatar | ato | 12 | icon/default, icon/default-reverse, icon/disabled, background/hover… | 1.1.1, 1.4.10, 1.4.4, 2.4.7, 2.5.8 | imagery, hexagon-masks, typography-usage | 6 |
...
| Cards | mol | 14 | background/default, color/primary, icon/default, icon/default-reverse… | 1.4.11, 1.4.3, 2.1.1, 2.4.7 | elevation, imagery, hexagon-masks, icons | 1 |
...
| List items | mol | 15 | color/primary, icon/default, icon/default-reverse, icon/disabled… | 1.3.1, 1.4.3, 2.5.7, 2.5.8, 4.1.2, 4.1.3 | typography-usage, icons |  |
...
| Navigations | org | 15 | background/default, color/primary, border/subsection, elevation/functional… | 1.3.1, 1.4.1, 2.1.2, 2.4.1, 2.4.11, 2.4.5, 2.5.8, 4.1.2 | platform-web, platform-app, icons | 6 |
| Notifications | mol | 16 | elevation/functional, icon/default, icon/default-reverse, text/default | 1.4.1, 1.4.3, 3.3.1, 4.1.3 | tone-of-voice, cookie-notifications, icons | 2 |
...
| Reorder | ato | 3 | icon/default, background/hover | 1.4.1, 2.1.1, 2.5.7, 2.5.8, 4.1.2 | icons |  |

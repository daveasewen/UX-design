...
**Totals:** 32 components · 19 with deprecated bindings · 12 god-nodes (blast≥7).
...
| Button | ato | 23 | icon/default, icon/default-reverse, icon/disabled, background/hover… | 1.4.11, 1.4.3, 2.1.1, 2.4.7, 2.5.8, 4.1.2 | calls-to-action |  |
...
| Slider | mol | 8 | background/default, border/default, background/hover, text/default | 1.4.1, 2.1.1, 2.5.7, 2.5.8, 4.1.2 | forms | 1 |
...
| View options | mol | 8 | border/default, icon/default, icon/default-reverse, text/default | 1.4.1, 2.1.1, 2.5.8, 4.1.2 | view-controls-sort, calls-to-action | 4 |

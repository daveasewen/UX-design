...
def build_fixture(root, script_text, banner):
    ...
    # #304 R1 — the memento-schematic gate, wired in the SAME edit as its stub (no sixth blind-harness).
    ...
    write(os.path.join(root, "reviews", "MEMENTO-SCHEMATIC-2026-08-07-v2.html"), "<p>schematic at HEAD</p>\n")
...
def arm_happy_path(script_text):
    with tempfile.TemporaryDirectory() as root:
        ...
        # #304 R1 — the memento-schematic gate's two halves, SEEN to run on the happy path.
...
ARMS = [
    ...
    # #304 R1 — the memento-schematic gate ([125] re-stale class): driven, hatched, and mutation-bitten

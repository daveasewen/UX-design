...
| `DV-D02` | **PROVEN** | (all seven cartesian, placed in the DV-D02-A partition in the same change per its import-time | knowledge/_validate_dataviz.py | `_proforma/_DATAVIZ-DECISIONS.md` |
...
| `DV-D20` | **UNPROVEN** | Node: DV-D20 | — | `_proforma/_DATAVIZ-DECISIONS.md` |

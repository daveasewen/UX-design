...
**135 snippet(s)** · **0 failure(s)** · **286 warning(s)** · **664 note(s)**

Measured MARKUP-DRIVEN (s114-D5, rebuilt #116): **1310 control(s)** and **239 focusable data mark(s)** enumerated from the markup, sized through a subject-aware cascade with `var()` resolved. Engine + declared gaps: `knowledge/_a11y_target.py`.

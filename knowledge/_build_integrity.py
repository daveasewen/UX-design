...
KNOWN_SC = {
 ...
 "2.1.1","2.1.2","2.2.1","2.2.2","2.3.3","2.4.1","2.4.2","2.4.3","2.4.4","2.4.5","2.4.6","2.4.7","2.4.8",
 "2.4.11","2.5.5","2.5.7","2.5.8","3.2.1","3.2.3","3.3.1","3.3.2","3.3.3","4.1.1","4.1.2","4.1.3"}
...
# repair sub: 2.4.2 / 3.2.3 / 3.3.3 added with their M-table rows in
# knowledge/compliance/_build_compliance_kg.py (SAME commit — the two tables move together).
# Cited by Template error (2.4.2 Page Titled A, 3.2.3 Consistent Navigation AA) and
# Template — create / edit form / Template — multi-step wizard (3.3.3 Error Suggestion AA).

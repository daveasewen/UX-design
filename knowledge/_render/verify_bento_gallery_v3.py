#!/usr/bin/env python3
"""Render-verify + drive knowledge/_fitness-test/bento-gallery-showcase-v3.html.
...
PAGE = "file://" + REPO + "/knowledge/_fitness-test/bento-gallery-showcase-v3.html"
...
def stage_probe(pg):
    ...
    for th in THEMES:
        for mode in ("light", "dark"):
            ...
            names = LOCAL_VARS + FS_VARS + DZ_VARS
            ...
            bad = bool(empty) or flat_ink or fs_flat or dz_flat
            ok &= not bad
...
def main():
    ...
    with sync_playwright() as p:
        ...
        print("SHOTS: " + " ".join(sorted(os.path.basename(f) for f in glob.glob(OUT + "/v3-*.png"))))
        b.close()

...
**Claim:** The component-spec KG is 102 files at knowledge/components/*.meta.json (the directory holds 106 entries - the other four are meta.schema.json, _ACCESSIBILITY-CONFORMANCE.md, _nodes-context.json and _nodes-pattern.json; the 92 includes the EXAMPLE template meta), and NOTHING in the build re-checks their token claims.

- check: `count=102 (want eq 102) in root=repo`

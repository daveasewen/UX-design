/* dv-render-line — the Chart-line / Chart-sparkline's cartesian value path TYPE PARTIAL for the dv-render engine.
   ...
   claimed the name, "the line type partial is NOT BUILT yet" means someone has and has not
   finished. Fail loud, and say which.

   WHAT THE LANE THAT FILLS THIS OWES: polyline data-fxs + data-ys (the fit grammar's path form), one .dv-mk circle per point, the category band shared with the column so a combo can overlay both.
...
(function () {
  ...
  function line() {
    throw new Error('dv-render-line: the line type partial is NOT BUILT yet — ' +
      'fill knowledge/canon/dv-render-line.js (registered stub, #259 engine-core lane)');
  }
  line.axis = 'y';
  window.dvRender.types['line'] = line;
  window.dvRender.types['multiline'] = line;
}());

...
Every selector appended to a composite list is a GLOBAL rule. Registry: `canon/_type-bindings.json`. Corpus: snippets + _proforma (114 files).

| radius | kind | selector | status |
|---:|---|---|---|
| 13 | class | `.btn` | PASS |
| 11 | class | `.stateLabel` | PASS |

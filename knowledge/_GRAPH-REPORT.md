...
**Totals:** 67 components · 942 tokens defined · 108 tokens referenced by components · compliance: 31 rules x 67 components (31 SCs).
...
834 of 942 defined tokens are unreferenced at the component layer. **Expected** for primitives and scale steps (consumed via semantic aliases, not bound directly); worth scanning the *semantic* groups for genuinely-dead tokens. By group:

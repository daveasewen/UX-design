...
**Totals:** 32 components · 616 tokens defined · 81 tokens referenced by components · compliance: 31 rules x 32 components (31 SCs).
...
535 of 616 defined tokens are unreferenced at the component layer. **Expected** for primitives and scale steps (consumed via semantic aliases, not bound directly); worth scanning the *semantic* groups for genuinely-dead tokens. By group:

...
**Totals:** 32 components · 627 tokens defined · 82 tokens referenced by components · compliance: 31 rules x 32 components (31 SCs).
...
545 of 627 defined tokens are unreferenced at the component layer. **Expected** for primitives and scale steps (consumed via semantic aliases, not bound directly); worth scanning the *semantic* groups for genuinely-dead tokens. By group:

...
## Back-to-top.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.
...
## Carousel.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.

## Cascader.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.
...
## Combobox.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.

## Command-palette.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.
...
## Document-row.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.
...
## Image-block.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.
...
## Legend.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.

## Limits-meter.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.
...
## Multi-select.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.
...
## Payment-card-visual.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.

## Popconfirm.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.
...
## Qr-code.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.

## Quick-actions.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.

## Range-slider.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.

## Rating.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.

## Reorder.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.

## Runway-bar.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.
...
## Sidebar-nav.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.
...
## Split-button.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.

## Splitter.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.

## Standing-order-mandate-row.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.
...
## Tags-input.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.
...
## Transaction-row.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.

## Transfer-list.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.

## Tree.reference.html — ✅ PASS
- token fidelity (light+dark), ARIA, contrast pairs, all-caps, typography, copy-lint, focus — all clean.

#!/usr/bin/env python3
"""#290 wrap — step 4b: write the FORWARD title into GOOD-MORNING.md through the mover,
...
out = os.path.join(HERE, f"ops-290-title-{int(time.time())}.json")

#!/usr/bin/env python3
"""#290 wrap — run an ops file through `_gm_move.py`, DRY FIRST, receipts read back.

⛔ THE #166 CONTRACT, ENFORCED HERE RATHER THAN REMEMBERED:
   · the ops file is session-owned and uniquely named (`notes/_lanes/290/W/ops-290-*.json`)

#!/usr/bin/env python3
"""_build_page.py — bake REVIEW-icons-2026-09-16-v1.html (#277 lane RI).
...
_page-copy.json.
  ...
  python3 notes/_lanes/277/icons-propose/_build_page.py
"""
import glob
import json
import os
...
COPY = LANE / "_page-copy.json"
OUT = LANE / "REVIEW-icons-2026-09-16-v1.html"
...
ONE_FIG = {
    ...
    "RI-3": ("{n_multi}", "bases with more than one “active” glyph — and all {n_multi} of them "
                          "have a bare <code>-active</code>"),

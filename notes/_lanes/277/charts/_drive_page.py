#!/usr/bin/env python3
"""_drive_page.py — DRIVE the #277 lane CO review page, then screenshot it.
...
Then it writes screenshot.png (full page, desktop, LIGHT) beside the HTML.
    ...
    source knowledge/_render/seat_env.sh && \
      python3 notes/_lanes/277/charts/_drive_page.py
"""
import json
import re
import sys
...
REPO = LANE.parents[3]
PAGE = LANE / "REVIEW-charts-2026-09-15-v1.html"
...
() => {
  ...
  //   code/pre   file paths and identifiers (lane TO's reading, kept verbatim)
  //   blockquote s276-D5 quoted verbatim. Dave's words are not this page's naming,
  //              and rewording a ruling to pass a gate is the tail wagging the dog.
  //   td.defn    the authored $why sentences and the declared drop reasons. These
  //              are the artefact under review — they LAND in the metas — so they
  //              are data on this page exactly as a file path in <code> is.

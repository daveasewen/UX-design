# DAVE'S WORDS — #287 — 2026-09-19 (verbatim, never paraphrased)

provenance: 287 · 2026-09-19 · conductor Fable 5.1

## The opener put three items to him (in this order)

1. Whether his two #286 sentences — *"okay go on everything"* and *"okay size-on-the-existing-node"* — are inscribed as rulings.
2. The `sizes` key name on the eight logo nodes, and rebuilding the KG explorer so something reads the field. The conductor recommended keeping `sizes` and rebuilding.
3. The 58 prose locations across 10 live files that still call 256,000 a wall or a hard line (ratified runbook and ruling text among them).

The opener also reported the SECOND cold boot on the same setup: **74,120 real** this morning against **73,832** (#286), Δ +288 — a reading, stated to him, not a ruling.
...
## What each word settles (the conductor's reading, marked as such)

- **"inscribe"** ⇒ both #286 sentences become rulings. He did not say which id each takes, nor re-word either; the ruling text is his #286 words plus the conductor's #286 reading, which the #286 record already marks as the conductor's.
- **"keep `sizes` and rebuild."** ⇒ the key name `sizes` is now HIS word (it was the lane's until this line); the KG explorer is rebuilt to show it.

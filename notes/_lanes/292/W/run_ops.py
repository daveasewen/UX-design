#!/usr/bin/env python3
"""#292 wrap — run an ops file through `_gm_move.py`, DRY FIRST, receipts read back.

⛔ THE #166 CONTRACT, ENFORCED HERE RATHER THAN REMEMBERED:
   · the ops file is session-owned and uniquely named (`notes/_lanes/292/W/ops-292-*.json`)

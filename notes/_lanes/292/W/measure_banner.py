#!/usr/bin/env python3
"""#292 wrap — measure the ★ LATEST banner against `s241-D2` with the GATE'S OWN instrument.

The banner block = `banner292.md` + the two residual lines. The GENERATED residual line is

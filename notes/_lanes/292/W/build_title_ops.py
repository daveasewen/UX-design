#!/usr/bin/env python3
"""#292 wrap — step 4b: write the FORWARD title into GOOD-MORNING.md through the mover,
...
out = os.path.join(HERE, f"ops-292-title-{int(time.time())}.json")

...
4. Cover the relevant **states**: default / hover / pressed / focus / disabled /
   loading / error / empty.
5. Carry **provenance** — note which canon component and tokens each part came from.
...
1. Read the request. Find the canon components each screen needs — look in
   ...
   and `knowledge/snippets/` for the reviewed markup/CSS.

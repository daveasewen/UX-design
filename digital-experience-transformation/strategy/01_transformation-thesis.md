...
The **Smart Design System** (project Promenaut; see `../project-context-summary.md`) is a working instance of the new operating model. Its principles *are* the team's new operating principles:

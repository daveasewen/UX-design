# READ FIRST — status of these strategy files

**These are drafts for your review, not settled positions.**

You asked to keep the strategy separate from the commit-safe context so you can review before committing. Everything in this `strategy/` folder is **v0.1 — a strong first articulation to react to**, not a finished plan. The context files one level up (`project-context-summary.md`, `kickoff-prompt.md`) are factual and safe to use as-is; these are opinionated and should be challenged, edited, and made yours.
...
## How to use them
Read the thesis first. If the spine of the argument holds for you, the other four are downstream of it and easy to adjust. Mark anything you disagree with; the fastest way to firm this up is to take it into the new project (via `kickoff-prompt.md`) and work it section by section.

# The Smart Design System — project context summary
...
Everything is plain Markdown + typed data (JSON Schema contracts, DTCG tokens), versioned in Git, conforming to open agent standards (`AGENTS.md`, Agent Skills / `SKILL.md`, MCP). It runs the same under Claude, other frontier models, or the Promenaut runtime without rewrites.

...
*Last refreshed: 2026-08-01 (Sat ~20:45 BST from `date` — #73 wrap, rolls run FIRST, declarations authored LAST and re-read against the artefacts. Previous: #72 (in-window conductor wrap).)*

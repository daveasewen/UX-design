...
## ⏱ LATEST DELTA — 2026-07-22 (morning→midday, FABLE solo) — "★ ADR-0014 RULED + BUILT: the neutral DNA tier · warm ramp PULLED from Figma · anchor remap · state-snap gate · R-D23/24/25 enacted · graph seed reconciled (zero mismatch) · build 45/45"
...
**70 decision nodes — 55 LIVE · 6 AMENDED · 8 DEAD · 1 OPEN.** Full typed edges + what-touches-this map: `knowledge/_DECISION-GRAPH.md`.

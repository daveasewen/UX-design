...
*Last refreshed: 2026-08-02 (Sun from `date` — #87 wrap: the OWED WRAP ×2 ran — #86's 19 rulings inscribed + propagated · bankruptcy executed (17 governing records + INERT archive, pile 3 untouched) · #85/#86 = HOLE lines, never reconstructed · both hand-patches removed · the chain certifies #87.)*

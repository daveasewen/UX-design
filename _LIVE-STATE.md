...
*Last refreshed: 2026-08-01 (Sat ~21:25 BST from `date` — #74 wrap, rolls run FIRST, declarations authored LAST and re-read against the artefacts. Previous: #73 (same discipline).)*

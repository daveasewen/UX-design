...
*Last refreshed: 2026-08-02 (Sun ~11:17 BST from `date` — #78 wrap: P0 diagnosed AGED PIN + fixed, phase-2 P1–P4 built under #78-D1…D3, DV-D19 specimen rebuilt on real canon. 2c/2d/2f run via `_gm_move.py`, receipts in stdout; residual line GENERATED. Previous: 2026-08-02 #77.)*

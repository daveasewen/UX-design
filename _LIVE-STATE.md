...
- **OPEN (Dave's):** **§C·2 item 20 — close it as discharged, or narrowly?** · DV-J2b sparkline half (queued, split by his ruling) · ds-020 DV-D07 catch-up (needs the paired control) · consumes-manifest TENTATIVE→firm · consult-receipts probe promotion · M12's UNATTENDED fire Sun 08-02 07:10 · §C·2's 15 rulings + dataviz sign-off · calm-banner verdict · LS-trim-vs-defer (P4b).

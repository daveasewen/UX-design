...
- **STILL HELD → NEXT:** all reds (`--err` `#A8000B`/`#DB0011`), `--warn` `#FFBB33`, `--info` navy — the **red tuner** (R-D17/R-D19) + owed Mono `tabs/active` + `progress/complete`. Only after red is ruled → flip `_validate_theme_provenance.py` to blocking.

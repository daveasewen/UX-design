...
*Last refreshed: 2026-08-02 (Sun ~09:51 BST from `date` — #77 wrap, the testing regime's first live run. ✅ **2c/2d/2f ALL RAN** (#75 banner · #74 delta · #76 stratum via `roll_2f`). The roll-residual in the GM banner is GENERATED by `_roll_state.py` from this wrap forward (#77-D1). Previous: 2026-08-02 #76.)*

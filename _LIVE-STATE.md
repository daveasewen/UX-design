...
- **Commits: wave `60e4dc1` (92 files) + the wrap commit carrying this delta — Dave pushes BOTH via GitHub Desktop.** NEXT: wave 2 per the divvy in GOOD-MORNING §C·1 (A-continuation 5 items + Data-grid lane + Charts lane — the two lane-sized briefs need cutting first).

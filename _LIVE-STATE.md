...
*Last refreshed: 2026-08-02 (Sun from `date` — #79 wrap: DV-D19 fully settled (swatch-at-rest RULED narrow, specimen signed off), P5+P6+P7 ruled and built by 3 subs, the shipped package's "verbatim" violation repaired and gated. 2c/2d/2f run via `_gm_move.py`, dry-run first, receipts in stdout; residual line GENERATED. Previous: 2026-08-02 #78.)*

...
## ⏱ LATEST DELTA — 2026-07-20 — "Button ladder → canonical 3-tier tokens; the Sutherland/canonical-core strategy locked"
...
- **HOUSEKEEPING:** amber gauge threshold moved **0.45 → 0.50** (`_context_gauge.py` + runbook). ⚠️ **GOOD-MORNING.md is STALE** (still shows the T9/tokenize "do first" — all DONE) — **refresh it next session** (first task, with the ADR). Memory-index compaction still DUE (~20KB).

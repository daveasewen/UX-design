...
*Last refreshed: 2026-08-01 (Sat ~22:30 BST from `date` — #75 wrap. ⚠ **2c/2d/2f rolls NOT run — declared, not silent** (see the ★ LATEST residual); the delta stack therefore carries one stratum more than the contract allows. Previous: #74 (rolls run first).)*

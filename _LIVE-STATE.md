...
- **★ RULINGS SHEET AWAITING DAVE:** `reviews/DECISION-GRAPH-CONVENTION-2026-07-21-v1.html` (+ .REVIEW overlay) — 8 decision controls, defaults = recommendations, live export block. **Sub-call resolved by the audit:** judgment half = done (seed); inscription = mechanical → recommend Sonnet transcribes, generator verifies. Build green 37/37 untouched. History: `_DECISION-HISTORY/2026-07-21-decision-graph-edge-convention.md`.
